...
@section('content')
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <ul class="nav nav-tabs html-source" id="html-source-code" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active ml-1 html-code" id="html-code" data-toggle="tab"
                                   href="#html-code" role="tab" aria-controls="html-code" aria-selected="true"><i
                                        class="fab fa-html5 text-orange ml-2"></i>HTML</a>
                            </li>
                        </ul>
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="element1"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="row row-xs wd-xl-80p">
	<div class="col-sm-6 col-md-3">
		<button class="btn btn-primary btn-block">Primary</button>
	</div>
	<div class="col-sm-6 col-md-3 mg-t-10 mg-sm-t-0">
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <ul class="nav nav-tabs html-source" id="html-source-code22" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active ml-1 html-code" id="html-code22" data-toggle="tab"
                                   href="#html-code22" role="tab" aria-controls="html-code22" aria-selected="true"><i
                                        class="fab fa-html5 text-orange ml-2"></i>HTML</a>
                            </li>
                        </ul>
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="element33"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="row row-xs wd-xl-80p">
	<div class="col-sm-6 col-md-3">
		<button class="btn btn-primary-gradient btn-block">Primary</button>
	</div>
	...
	<div class="col-sm-6 col-md-3 mg-t-10">
		<button class="btn btn-dark-gradient btn-block">Dark</button>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#element33"><i
                                    class="las la-clipboard"></i></div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
                ...
                <div class="card-footer">
                    <table class="table main-table-reference mt-0 mb-0">
                        ...
                        <tr>
                            <td><code class="pd-0 bg-transparent">class="btn btn-[value]"</code></td>
                            <td>primary-gradient | secondary-gradient | success-gradient | warning-gradient |
                                danger-gradient | info-gradient | light-gradient | dark-gradient
                            </td>
                        </tr>
                        </tbody>
                    </table>
            ...
            <div class="card" id="button2">
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="element2"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="row row-xs wd-xl-80p">
	<div class="col-sm-6 col-md-3">
		<button class="btn btn-outline-primary btn-block">Primary</button>
	</div>
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <div class="row row-xs wd-xl-80p">
                                <div class="col-sm-6 col-md-3">
                                    <button class="btn btn-indigo btn-rounded btn-block">Primary</button>
                                </div>
                                <div class="col-sm-6 col-md-3 mg-t-10 mg-sm-t-0">
                                    <button class="btn btn-outline-indigo btn-rounded btn-block">Primary</button>
                                </div>
                                <div class="col-sm-6 col-md-3 mg-t-10 mg-md-t-0">
                                    <button class="btn btn-secondary btn-rounded btn-block">Secondary</button>
                                </div>
                                <div class="col-sm-6 col-md-3 mg-t-10 mg-md-t-0">
                                    <button class="btn btn-outline-secondary btn-rounded btn-block">Secondary</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="element3"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="row row-xs wd-xl-80p">
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <div class="row row-xs wd-xl-80p">
                                <div class="col-sm-6 col-md-3">
                                    <button class="btn btn-indigo btn-with-icon btn-block"><i
                                            class="typcn typcn-folder"></i> Folder
                                    </button>
                                </div>
                                <div class="col-sm-6 col-md-3 mg-t-10 mg-sm-t-0">
                                    <button class="btn btn-primary btn-with-icon btn-block"><i
                                            class="typcn typcn-mail"></i> Mail
                                    </button>
                                </div>
                                <div class="col-sm-6 col-md-3 mg-t-10 mg-md-t-0">
                                    <button class="btn btn-success btn-with-icon btn-block"><i
                                            class="typcn typcn-edit"></i> Edit
                                    </button>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="element4"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="row row-xs wd-xl-80p">
                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <div class="btn-icon-list">
                                ...
                                <button class="btn btn-primary btn-icon"><i class="typcn typcn-calendar-outline"></i>
                                </button>
                                <button class="btn btn-success btn-icon"><i class="typcn typcn-document-add"></i>
                                </button>
                                <button class="btn btn-info btn-icon"><i class="typcn typcn-arrow-back-outline"></i>
                                </button>
                            </div>
                        </div>
                        <ul class="nav nav-tabs html-source" id="html-source-code5" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active ml-1 html-code" id="html-code5" data-toggle="tab"
                                   href="#html-code5" role="tab" aria-controls="html-code5" aria-selected="true"><i
                                        class="fab fa-html5 text-orange ml-2"></i>HTML</a>
                            </li>
                        </ul>
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="element5"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="btn-icon-list">
	<button class="btn btn-indigo btn-icon"><i class="typcn typcn-folder"></i></button>
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <div class="row row-xs wd-xl-80p">
                                <div class="col-sm-6 col-md-3">
                                    <button data-toggle="dropdown" class="btn btn-indigo btn-block">Dropdown <i
                                ...
                                <div class="col-sm-6 col-md-3 mg-t-10 mg-sm-t-0">
                                    <button data-toggle="dropdown" class="btn btn-primary btn-block">Dropdown <i
                                            class="icon ion-ios-arrow-down tx-11 mg-l-3"></i></button>
                                    <div class="dropdown-menu">
                                        <a href="" class="dropdown-item">Profile</a>
                                        <a href="" class="dropdown-item">Activity Logs</a>
                        ...
                        <ul class="nav nav-tabs html-source" id="html-source-code6" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active ml-1 html-code" id="html-code6" data-toggle="tab"
                                   href="#html-code6" role="tab" aria-controls="html-code6" aria-selected="true"><i
                                        class="fab fa-html5 text-orange ml-2"></i>HTML</a>
                            </li>
                        </ul>
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="element6"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="row row-xs wd-xl-80p">
	<div class="col-sm-6 col-md-3">
	...
	<div class="col-sm-6 col-md-3 mg-t-10 mg-sm-t-0">
		...
		<div class="dropdown-menu">
			...
			<a href="" class="dropdown-item">Logout</a>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#element6"><i
                                    class="las la-clipboard"></i></div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <div class="row row-sm">
                                ...
                                <div class="col-lg-2 mg-t-20 mg-lg-t-0">
                                    <div aria-label="Basic example" class="btn-group" role="group">
                                        <button class="btn btn-secondary btn-icon active" type="button"><i
                                                class="typcn typcn-media-play-outline"></i></button>
                                ...
                                <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                                    <div aria-label="Basic example" class="btn-group" role="group">
                                        <button class="btn btn-indigo btn-icon active" type="button"><i
                                                class="typcn typcn-media-play-outline"></i></button>
                        ...
                        <ul class="nav nav-tabs html-source" id="html-source-code7" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active ml-1 html-code" id="html-code7" data-toggle="tab"
                                   href="#html-code7" role="tab" aria-controls="html-code7" aria-selected="true"><i
                                        class="fab fa-html5 text-orange ml-2"></i>HTML</a>
                            </li>
                        </ul>
                        <!-- Prism Precode -->
                        <figure class="highlight clip-widget" id="element7"><pre><code class="language-markup"><script
                                        type="html-dashlead/script"><div class="row row-sm">
	<div class="col-lg-4">
		<div aria-label="Basic example" class="btn-group" role="group">
	...
	<div class="col-lg-4 mg-t-20 mg-lg-t-0">
		<div aria-label="Basic example" class="btn-group" role="group">
			<button class="btn btn-indigo btn-icon active" type="button"><i class="typcn typcn-media-play-outline"></i></button> <button class="btn btn-primary btn-icon" type="button"><i class="typcn typcn-media-pause-outline"></i></button> <button class="btn btn-primary btn-icon" type="button"><i class="typcn typcn-media-stop-outline"></i></button>
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#element7"><i
                                    class="las la-clipboard"></i></div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
